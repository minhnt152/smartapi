...
namespace smartapi.Controllers
{
    ...
    public class AccessEventController : ControllerBase
    {
        ...
        public ActionResult <AccessEventItemDto> GetAccessEvents([FromQuery]DateTime? startDate, [FromQuery]DateTime? endDate,
                                                                 [FromQuery]DateTime? dbStartDate, [FromQuery]DateTime? dbEndDate,
                                                                 ...
                                                                 [FromQuery]int? eventCode, [FromQuery]int? direction, [FromQuery]int pos)
        {
            int lastPost = pos;
            bool hasMore = false;
            var items = _repository.GetAccessEvents(startDate, endDate,dbStartDate,dbEndDate, cardNo ,chId, chName, doorName, eventCode, direction, pos, out lastPost, out hasMore);
